...
export const experienceEntries = [
  ...
  },
  {
    ...
    month: 5,
    description: [
      'Standardized architecture across 5+ fragmented microservices and consolidated coupled authentication and token verification flows, resolving a recurring session corruption bug class in four weeks while mentoring 2 to 3 engineers.',
